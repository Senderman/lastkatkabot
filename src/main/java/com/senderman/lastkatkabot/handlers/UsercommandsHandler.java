...
public class UsercommandsHandler {
    ...
    public void marryme(Message message) {
        ...
        if (!message.isReply() || message.getFrom().getId().equals(message.getReplyToMessage().getFrom().getId()) || message.getReplyToMessage().getFrom().getBot() || countBackspaces < 1 || message.isUserMessage().equals("private"))
            return;
